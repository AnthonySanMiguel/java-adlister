...
public class MySQLContactsDao implements Contacts {
    ...
    public List<Contact> getContacts() {
        ...
        try {
            ...
            // Iterate through result set and add each contact to our 'Contact' bean
            while (rs.next()) {
                output.add(
                        new Contact(
                                rs.getLong("id"), // id
        ...
        return output; // returns the List<Contact> of all the contacts imported from the MySQL database
    }
    ...
    public void deleteContactById(long id) {
        // 'id' passed in is the id of the row we want to delete from our database table
    ...
    public Contact getContactById(long id) {
        ...
        try {
            ...
            } else { // no match found for the id sent in
